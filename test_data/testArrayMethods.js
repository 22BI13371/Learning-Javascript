describe("camelize", function () {
  it("camelized 'background-color' is 'backgroundColor'", function () {
    assert.equal(camelize("background-color"), "backgroundColor");
  });

  it("camelized 'list-style-image' is 'listStyleImage'", function () {
    assert.equal(camelize("list-style-image"), "listStyleImage");
  });

  it("camelized '-webkit-transition' is 'WebkitTransition'", function () {
...
describe("filterRange", function () {
  ...
  it("doesnt affect the original", function () {
    let arr = [5, 3, 8, 1];
...
describe("Calculator", function () {
  ...
  it("calculate(aString1 + aString2) is NaN", function () {
    assert.isNaN(calculator.calculate("aString1 + aString2"));
  });
